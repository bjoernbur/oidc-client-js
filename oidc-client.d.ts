...
declare namespace Oidc {
  ...
  interface CordovaPopupWindowEvents {
    load(event: any, popup: CordovaPopupWindow);

    addLoad(callback: (...ev: any[]) => void): void;
    removeLoad(callback: (...ev: any[]) => void): void;
  }
  ...
  class CordovaPopupNavigator {
    ...
    events: CordovaPopupWindowEvents;
  }
